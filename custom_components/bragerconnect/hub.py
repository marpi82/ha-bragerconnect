...
class BragerHub(BragerConnect):
    """Hub class for BragerConnect service"""

    manufacturer = "Brager Sp. z o.o."

    def __init__(self, hass: HomeAssistant) -> None:
        """Init BragerConnect service Hub"""
        self._hass = hass
        super().__init__()

    async def connect(self, username: str, password: str, language: str = "en") -> None:
        return await super().connect(username, password, language)
